Locales['en'] = {
  ...
  ['armory_componenttitle'] = 'armory - Weapon attachments',
  ['armory_bought'] = 'you bought an %s for $%s',
  ['armory_money'] = 'you cannot afford that weapon',
  ['armory_hascomponent'] = 'you have that attachment equiped!',
  ['get_weapon_menu'] = 'armory - Withdraw Weapon',
  ['put_weapon_menu'] = 'armory - Store Weapon',
  ['confirm'] = 'Confirm',
  -- Vehicles
  ['press_to_enter'] = 'Press [E] to Spawn a Police Vehicle',
  ['vehicle_spawned'] = 'Police Car Spawned, Catch Some Criminals!',
